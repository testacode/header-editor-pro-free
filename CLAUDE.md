...
- **Copy Header to Profile**: Per-row 📋 button (shown when >1 profile) opens a dropdown to append the header (name + value, enabled) to another profile's same section, with toast confirmation
